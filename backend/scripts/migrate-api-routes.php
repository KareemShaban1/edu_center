...
function routeFileForPath(string $path): string
{
    ...
    if (in_array($path, ['/login', '/logout', '/user', '/register/parent', '/register/student', '/register/center', '/auth/memberships', '/auth/switch-tenant', '/auth/switch-center', '/auth/guards'], true)) {
        return 'auth';
    }
