...
$guard = $request->session()->get('api_auth_guard', 'web');
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json(['library' => $this->formatLibraryItem($library)], 201);
    }
    ...
    public function updateWithMedia(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json(['library' => $this->formatLibraryItem($library)]);
    }

    private function formatLibraryItem(Library $library): array
    {
        $tenantDb = DB::connection('center');
