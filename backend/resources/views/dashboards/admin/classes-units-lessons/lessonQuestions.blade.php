...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('questions.storeOrUpdateFromLesson') }}">
                @csrf
                <input type="hidden" name="class_id" value="{{ $lesson->unit->class_id }}">
...
<script>
    ...
    let newQuestionHTML = `
        <div class="question-block">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label">{{ trans('admin/classes_trans.Question') }}: ${questionIndex + 1}</label>
    ...
    function downloadWord() {
        ...
        let blob = new Blob([formattedContent], { type: 'application/msword' });
