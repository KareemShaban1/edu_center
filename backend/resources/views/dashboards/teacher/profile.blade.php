...
@section('title')
    {{ trans('Teacher_Dashboard/dashboard_profile_trans.Profile') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
    ...
    <section style="background-color: #eee; padding:10px">
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img src="{{ URL::asset('images/icons/teacher.png') }}" alt="avatar"
                            class="rounded-circle img-fluid" style="width: 150px;">
                        <h5 style="font-family: Cairo" class="my-3">{{ $teacher->name }}</h5>
                        <p class="text-muted mb-1">{{ $teacher->email }}</p>
                        <p class="text-muted mb-4">{{ trans('Teacher_Dashboard/dashboard_profile_trans.Teacher') }} </p>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('profile.update', $teacher->id) }}" method="post">
                            @csrf
                            <div class="row">

                                <div class="col-12 col-sm-3">
                                    <p class="mb-10">
                                        {{ trans('Teacher_Dashboard/dashboard_profile_trans.Arabic_User_Name') }}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-3">
                                    <p class="mb-10">
                                        {{ trans('Teacher_Dashboard/dashboard_profile_trans.English_User_Name') }}</p>
                                </div>
                            ...
                            <button type="submit" class="btn btn-success">
                                {{ trans('Teacher_Dashboard/dashboard_profile_trans.Edit_Information') }}
                            </button>
                        </form>
                    </div>
                </div>
