...
import type { ClassRoom, Grade, Section, SectionWeekDay } from '@/types/models';
...
type SectionPayload = Pick<Section, 'name' | 'grade_id' | 'class_id' | 'teacher_id'> & {
...
export const adminAcademicsApi = {
  ...
  async updateSection(id: number, payload: SectionPayload): Promise<Section> {
