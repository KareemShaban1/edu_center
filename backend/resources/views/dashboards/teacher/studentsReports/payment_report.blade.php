...
@section('title')
{{ trans('Teacher_Dashboard/reports_trans.Payment_Report') }}
@stop
@endsection
@section('page-header')
...
<table id="datatable" class="table nowrap table-hover table-sm table-bordered p-0" data-page-length="50"
    ...
    <thead>
        <tr>
            ...
            <th class="alert-success">{{ trans('Teacher_Dashboard/reports_trans.Payment_Date') }}</th>
            <th class="alert-success">{{ trans('Teacher_Dashboard/reports_trans.Amount') }}</th>
            <th class="alert-success">{{ trans('Teacher_Dashboard/reports_trans.Payment_Status') }}</th>
        </tr>
    </thead>
    <tbody>
                ...
                <td>
                    @if ($payment->payment_status == 1)
                        <span class="text-success">
                            {{ trans('Teacher_Dashboard/reports_trans.Paid') }}
                        </span>
                    @else
                        <span class="text-danger">
                            {{ trans('Teacher_Dashboard/reports_trans.Not_Paid') }}
                        </span>
                    @endif
                </td>
            </tr>
