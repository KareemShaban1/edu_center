...
@section('css')
@section('title')
{{ trans('admin/sections_trans.Sections_Attendance') }}
@stop
@endsection
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label
                                                                    ...
                                                                    {{ $section->status == 1
                                                                                ...
                                                                                : trans('admin/sections_trans.Inactive') }}
                                                                </label>
                                                            </td>
                                                            ...
                                                            <div class="relative inline-block text-left">
                                                                    <button type="button" class="bg-green-500 hover:bg-green-600 text-white text-xs px-3 py-2 rounded flex items-center gap-1"
                                                                        ...
                                                                        <i class="fa fa-cogs"></i> {{ trans('admin/attendance_trans.Processes') }}
                                                                    ...
                                                                    <div class="dropdown-menu absolute z-10 mt-1 bg-white rounded shadow-lg text-sm hidden group-hover:block"
                                                                        ...
                                                                        <a href="{{ route('attendance.show_attendance', [$section->id, carbon\Carbon::now('Egypt')->format('Y-m-d')]) }}"
                                                                            ...
                                                                            {{ trans('admin/attendance_trans.Today_Attendance') }}
                                                                        </a>
                                                                        <a href="{{ route('attendance.choose_attendance_day', $section->id) }}"
                                                                            class="block px-4 py-2 hover:bg-gray-100 text-gray-700 flex items-center gap-2" role="button"
                                                                            aria-pressed="true">
                                                                            <i class="fa fa-layer-group text-gray-500"></i>
                                                                            {{ trans('admin/attendance_trans.Choose_Attendance_Day') }}
                                                                        </a>
