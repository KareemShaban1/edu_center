    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('admin/students_trans.Delete_attachment')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Delete_attachment')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('admin/students_trans.Delete_attachment_tilte')}}</h5>
