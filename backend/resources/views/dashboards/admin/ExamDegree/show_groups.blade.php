...
@section('title')
{{ trans('admin/sections_trans.Sections_Exam') }}
@stop
                                                            ...
                                                            <td>
                                                                <div class="relative inline-block text-left">
                                                                    ...
                                                                    <div class="dropdown-menu absolute z-10 mt-1 bg-white rounded shadow-lg text-sm hidden group-hover:block"
                                                                        ...
                                                                        <a href="{{ route('ExamDegree.show_exam_degree', [$section->id, carbon\Carbon::now('Egypt')->format('Y-m-d')]) }}"
                                                                            ...
                                                                            {{ trans('admin/exams_trans.Today_Exam') }}
                                                                        </a>
                                                                        <a href="{{ route('ExamDegree.choose_exam_day', $section->id) }}"
