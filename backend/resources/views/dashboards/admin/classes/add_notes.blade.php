<!-- add_modal_class -->
<div class="modal fade" id="addNote{{ $class->id }}" tabindex="-1" role="dialog" aria-labelledby="AddNoteModal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{ route('notes.store') }}" method="POST">
                    @csrf
                    <input type="hidden" name="noteable_id" value="{{ $class->id }}">
                    <input type="hidden" name="noteable_type" value="{{ get_class($class) }}">
                    <div class="card-body">
