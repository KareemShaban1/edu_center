<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="navbar-brand-wrapper w-[230px] !important text-center">
        <a class="text-gray font-weight-bold text-2xl">
            <span>{{ App\Models\Setting::
                    where('key', 'center_name')->first()->value ?? 'Center Name' }}</span>
        </a>
    </div>
        ...
        <ul class="nav navbar-nav left-nav">
                        ...
                        <div class="card card-statistics h-100">
                            ...
                            <div class="col-12  p-0 main-box">
                                ...
                                <div class="col-12 p-3 row d-flex">
                                    ...
                                    <div class="col-4 d-flex justify-content-center align-items-center mb-3 py-2">
                                        <a href="{{ route('Payment.showGroups') }}"
            ...
            <li class="nav-item dropdown mr-30">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    {{-- Extra links based on guard --}}
                    @if (auth('student')->check())
                    <a class="dropdown-item" href="{{ route('student_profile.index') }}">
                        <i class="bx bx-user"></i> الملف الشخصي
                    </a>


                    @elseif(auth('teacher')->check())
                    <a class="dropdown-item" href="{{ route('profile.show.teacher') }}">
                        <i class="bx bx-user"></i> الملف الشخصي
                    </a>

                    @elseif(auth('parent')->check())
                    <a class="dropdown-item" href="{{ route('profile.show.parent') }}">
                        <i class="bx bx-user"></i> الملف الشخصي
                    </a>

                    @else
                    <a class="dropdown-item" href="{{ route('profile.show.admin') }}">
                        <i class="bx bx-user"></i> الملف الشخصي
                    </a>
                    @endif
