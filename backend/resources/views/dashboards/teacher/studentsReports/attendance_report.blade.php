...
@section('title')
    ...
    {{ trans('Teacher_Dashboard/reports_trans.Attendance_Report') }}
...
<h5 style="font-family: 'Cairo', sans-serif;color: red"> 
    {{ trans('Teacher_Dashboard/reports_trans.Today_Date') }} : {{ date('Y-m-d') }}
</h5>
...
<div class="table-responsive">
    ...
    <thead>
        <tr>
            ...
            <th class="alert-success">{{ trans('Teacher_Dashboard/reports_trans.Date') }}</th>
            <th class="alert-success">{{ trans('Teacher_Dashboard/reports_trans.Status') }}</th>
        </tr>
    </thead>
    <tbody>
                ...
                <td>
                    @if ($attendance->attendance_status == 1)
                        <span class="text-success">
                            {{ trans('Teacher_Dashboard/reports_trans.Presence') }}
                        </span>
                    @else
                        <span class="text-danger">
                            {{ trans('Teacher_Dashboard/reports_trans.Absent') }}
                        </span>
                    @endif
                </td>
            </tr>
